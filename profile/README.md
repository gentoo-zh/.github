...
[English](./README.en.md) | 简体中文 | [正體中文](./README.zh-TW.md)

</div>

# Gentoo-zh 社区

2003 年起于中文 Gentoo Linux 用户社区，现在服务所有 Gentoo 用户。

## Overlay

[gentoo-zh](https://github.com/gentoo-zh/overlay) 是一个 `masters = gentoo` 的 overlay，收录 490 多个软件包。
...
中国大陆镜像加速：https://gentoozh.org/overlay/
distfiles 与预编译二进制包：https://distfiles.gentoozh.org
...
[![Email](https://img.shields.io/badge/Email-overlay%40gentoozh.org-5A5A5A?logo=data:image/svg%2Bxml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCIgZmlsbD0iI2ZmZiI%2BPHBhdGggZD0iTTIgNGgyMHYxNkgyem0xMCAxMUwyIDh2LTJsMTAgNyAxMC03djJ6Ii8%2BPC9zdmc%2B)](mailto:overlay@gentoozh.org)
