...
Started in 2003 as the community for Chinese-speaking Gentoo Linux users.
Now serving all Gentoo users.
...
Mirrors for mainland China: https://gentoozh.org/overlay/
Distfiles and prebuilt binary packages: https://distfiles.gentoozh.org
